...
Most posts here will come from work I have actually done: React and Next.js patterns I would still use in production, interface details that improve clarity, and architecture decisions that make a codebase easier to change without adding weight.
