...
summary: A CLI for creating React projects with app-shell foundations ready.
...
A Forge project starts with the recurring setup already in place, while staying small enough for a team to inspect, own, and replace piece by piece.

The package is prepared as `create-use-forge` version `0.1.4`. It is not publicly released yet; npm publishing and registry checks for the initializer commands are still pending.
